  ...
  <script>
    const I18N = {
      en: {
        ...
        'btn.update': 'Update',
        'st.fwLink': 'Download the firmware: <a href="https://github.com/function3d/petalot/tree/master/Firmware#petalot-firmware" target="_blank" rel="noopener">petalot .bin files on GitHub</a>',
