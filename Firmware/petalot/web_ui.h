  ...
  <script>
    const I18N = {
      ...
      es: {
        ...
        't.confirmReset': '¿Restablecer de fábrica? No se restablecerán las estadísticas, temperatura, desplazamiento ni la sintonía de calentamiento (HYS/RAMP/HOLD)',
        't.done': 'Hecho',
      ...
      pt: {
        ...
        't.restarting': 'Reiniciando...',
        't.confirmReset': 'Restaurar de fábrica? Estatísticas, temperatura, deslocamento e ajuste de aquecimento (HYS/RAMP/HOLD) não serão resetados',
        't.done': 'Concluído',
      ...
      fr: {
        ...
        't.confirmReset': "Réinitialiser ? Les statistiques, la température, le décalage et le réglage du chauffage (HYS/RAMP/HOLD) ne seront pas réinitialisés",
        't.done': 'Terminé',
      ...
      de: {
        ...
        't.confirmReset': 'Zurücksetzen? Statistiken, Temperatur, Offset und Heizabstimmung (HYS/RAMP/HOLD) werden nicht zurückgesetzt',
        't.done': 'Fertig',
        'gs.update': 'Firmware-Update',
      ...
      it: {
        ...
        't.confirmReset': 'Ripristino? Statistiche, temperatura, offset e regolazione riscaldamento (HYS/RAMP/HOLD) non verranno azzerati',
        't.done': 'Fatto',
      ...
      zh: {
        ...
        't.confirmSave': '确定吗？',
        't.restarting': '正在重启...',
        't.confirmReset': '恢复出厂设置？统计数据、温度、偏移和加热调校 (HYS/RAMP/HOLD) 不会被重置',
        't.done': '完成',
        'gs.update': '固件更新',
        'btn.update': '更新',
      ...
      cs: {
        ...
        't.confirmReset': 'Tovární reset? Statistiky, teplota, korekce teploty a nastavení ohřevu (HYS/RAMP/HOLD) nebudou resetovány',
        't.done': 'Hotovo',
      ...
      ru: {
        ...
        't.confirmReset': 'Сброс? Статистика, температура, коррекция температуры и настройка нагрева (HYS/RAMP/HOLD) не будут сброшены',
        't.done': 'Готово',
      ...
      tr: {
        ...
        't.confirmReset': 'Fabrika ayarlarına sıfırlansın mı? İstatistikler, sıcaklık, sıcaklık ofseti ve ısıtma ayarı (HYS/RAMP/HOLD) sıfırlanmaz',
        't.done': 'Tamam',
      ...
      ja: {
        ...
        't.restarting': '再起動中...',
        't.confirmReset': '工場出荷時リセットしますか？統計、温度、温度オフセット、加熱調整 (HYS/RAMP/HOLD) はリセットされません',
        't.done': '完了',
        'gs.update': 'ファームウェア更新',
        'btn.update': '更新',
      ...
      ko: {
        ...
        't.confirmSave': '확실합니까？',
        't.restarting': '재시작 중...',
        't.confirmReset': '공장 초기화하시겠습니까？통계、온도、온도 오프셋、가열 튜닝 (HYS/RAMP/HOLD) 은 초기화되지 않습니다',
        't.done': '완료',
        'gs.update': '펌웨어 업데이트',
        'btn.update': '업데이트',
